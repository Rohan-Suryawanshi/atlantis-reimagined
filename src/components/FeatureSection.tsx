...
const features = [
   {
      ...
      title: "Accurate Inspections",
      desc: "High-precision NDT inspections ensuring safety, compliance, and reliability.",
   },
   {
      icon: <ScanLine size={48} className="text-green-500" />,
      title: "Advanced Techniques",
      desc: "We utilize UT, RT, MT, PT, and other advanced NDT methods for reliable results.",
   },
   {
