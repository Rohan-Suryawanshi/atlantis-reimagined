...
export const Hero = () => {
  ...
  return (
    <section ref={heroRef} className="relative min-h-screen flex items-center overflow-hidden bg-gradient-to-br from-background via-secondary/20 to-accent/10">
      {/* Animated Background */}
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          >
            ...
            <span className="text-primary font-semibold">1000+ inspections</span>, and{' '}
            <span className="text-primary font-semibold">Level III consultants</span>
          </motion.p>
