   ...
   const services = [
      {
         ...
         description:
            "Comprehensive NDT testing with certified Level III professionals.",
         features: [
            "Ultrasonic Testing",
            ...
            <div className="container mx-auto px-6">
               ...
               >
                  <h2 className="text-3xl md:text-4xl font-bold mb-6">
                     Challenging{" "}
                     <span className="gradient-text">Inspection Problem?</span>
                  </h2>
                  <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                     Our comprehensive NDT solutions cover every aspect of
                     non-destructive testing, from complex inspections to
