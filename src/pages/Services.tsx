        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground leading-relaxed">
              Comprehensive Non-Destructive Testing services with state-of-the-art equipment 
              and certified methodologies for critical asset inspection.
            </p>
          </motion.div>
        </div>
      </motion.section>
      ...
      <section className="py-20">
        <div className="container mx-auto px-6">
          <motion.div 
            ...
            transition={{ duration: 0.8 }}
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Our Testing Methods</h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Advanced NDT techniques performed by certified Level III professionals using industry-leading equipment.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-secondary/30">
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Trusted by leading companies across multiple industries for critical asset inspection and integrity management.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground mb-6">
                ...
                or web-based Digital Twins used for asset integrity and enhanced learning 
                programs in NDT.
              </p>
              ...
              <Card className="p-8 bg-gradient-card border-0 shadow-lg">
                <CardContent className="p-0 text-center">
                  ...
                  <p className="text-muted-foreground">
                    Leveraging cutting-edge VR/AR technology to provide immersive training 
                    experiences and comprehensive asset integrity solutions.
                  </p>
                </CardContent>
              </Card>
            </motion.div>
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          >
            ...
            <p className="text-xl mb-8 max-w-2xl mx-auto opacity-90">
              Contact us today for a customized NDT solution tailored to your specific requirements.
            </p>
            <Button 
              size="lg" 
              variant="outline" 
